...
from library_management_app import models, forms
...
def userregister(request):
    ...
    if request.user.is_authenticated:
        return redirect("library_management_app:home-page")
...
def logout_user(request):
    logout(request)
    return redirect('library_management_app:login-page')
...
def manage_user(request, pk=None):
    ...
    if pk is None:
        ...
        context['user'] = CustomUser.objects.get(id=pk)  # Use CustomUser instead of User
