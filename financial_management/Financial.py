...
def staff_salary_list(request):
    ...
    return render(request, 'financial/staff_salary_list.html', context)
...
def driver_salary_list(request):
    ...
    return render(request, 'financial/driver_salary_list.html', context)
...
def security_salary_list(request):
    ...
    return render(request, 'financial/security_salary_list.html', context)
...
def cooker_salary_list(request):
    ...
    return render(request, 'financial/cooker_salary_list.html', context)
...
def car_expense_list(request):
    ...
    return render(request, 'financial/car_expense_list.html', context)
