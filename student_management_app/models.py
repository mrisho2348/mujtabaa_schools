...
class Students(models.Model):
    ...
    service_type = models.CharField(max_length=100, default='school',null=True, blank=True)    
    date_of_birth = models.DateField(blank=True, null=True)
    gender = models.CharField(max_length=10)    
    phone_number = models.CharField(max_length=20)
    education_level = models.ForeignKey(EducationLevel, on_delete=models.CASCADE, null=True, blank=True)    
    selected_class = models.ForeignKey(Class_level, on_delete=models.SET_NULL, null=True, blank=True)   
    birth_certificate_id = models.CharField(max_length=100,null=True, blank=True)
    ...
    physical_disability = models.CharField(max_length=200,null=True, blank=True)
