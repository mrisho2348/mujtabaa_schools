# Generated by Django 4.2.1 on 2023-11-12 00:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('school_level', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.educationlevel')),
            ],
        ),
        migrations.AddField(
            model_name='car',
