# Generated by Django 4.2.1 on 2024-01-06 00:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('your_subject', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_certificate_photo', models.FileField(blank=True, null=True, upload_to='student_birth_certificate_photos/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('education_level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='student_management_app.educationlevel')),
                ('selected_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='student_management_app.class_level')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('driver', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='student_management_app.schooldriver')),
        ...
        migrations.AddField(
            model_name='students',
            name='subjects',
            field=models.ManyToManyField(blank=True, related_name='students', to='student_management_app.subject'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_certificate_photo', models.FileField(blank=True, null=True, upload_to='stass_birth_certificate_photo')),
                ('fcm_token', models.TextField(default='')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('education_level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='student_management_app.educationlevel')),
                ('subjects', models.ManyToManyField(blank=True, related_name='staffs_subjects', to='student_management_app.subject')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificate_url', models.FileField(blank=True, null=True, upload_to='staff_skill_certificate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cv', models.FileField(blank=True, null=True, upload_to='staff_cv')),
                ('other_certificates', models.FileField(blank=True, null=True, upload_to='staff_other_certificates')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('staff', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.staffs')),
            ],
        ...
        migrations.AddField(
            ...
            name='school_level',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.educationlevel'),
        ),
        migrations.AddField(
            model_name='car',
            name='owner',
